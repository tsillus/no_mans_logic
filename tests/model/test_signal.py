...
def test_two_signals_are_equal_when_their_currents_are_equal():
    assert Signal(True, Vector(0, 0)) == Signal(True, Vector(0, 0))
    assert Signal(False, Vector(0, 0)) == Signal(False, Vector(0, 0))
    assert Signal(True, Vector(0, 0)) != Signal(False, Vector(0, 0))
