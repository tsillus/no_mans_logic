...
def test_rotates_by_90_degree_steps_clockwise_for_positive_values():
    assert Vector(1, 0).rotate_90(0) == Vector(1, 0)
    assert Vector(1, 0).rotate_90(1) == Vector(0, 1)
    assert Vector(1, 0).rotate_90(2) == Vector(-1, 0)
    assert Vector(1, 0).rotate_90(3) == Vector(0, -1)
    assert Vector(1, 0).rotate_90(4) == Vector(1, 0)
